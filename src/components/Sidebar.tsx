...
//   onSubMenuItemClick: (menuId: PageType, itemId: SubPageType) => void;
//   onLogout?: () => void;
//   userRole: 'Distributor' | 'Customer'; // Updated userRole prop
// }
...
//   // Set expandable menus state
//   const [expandedMenus, setExpandedMenus] = useState<Record<string, boolean>>({
//     // Set assets menu expanded by default
//     'assets': true
//   });

//   // Menu items data structure with protected flag
//   const menuItems = [
//     {
//       id: 'dashboard',
//       label: 'Dashboard',
...
//             // Determine if menu item is disabled for non-distributors
//             const isDisabled = userRole !== 'Distributor' && menuItem.protected;
...
//                   onClick={() => !isDisabled && toggleSubmenu(menuItem.id)}
//                 >
//                   <div className="flex items-center">
//                     <span className={`mr-3 ${activePage === menuItem.id ? 'text-blue-500' : 'text-gray-400'}`}>
//                       {menuItem.icon}
...
//                             isActive ? 'bg-[#2d4c6d] text-white' : 'hover:bg-[#252a2e] text-gray-400'
//                           } ${isDisabled ? 'opacity-50 cursor-not-allowed' : ''}`}
//                           onClick={() => !isDisabled && onSubMenuItemClick(menuItem.id as PageType, subItem.id)}
//                         >
//                           {subItem.label}
//                         </div>
//                       );
