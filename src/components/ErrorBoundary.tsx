        ...
        <div className="fixed inset-0 bg-gradient-page flex flex-col items-center justify-center z-50 p-6">
          ...
          {this.state.error && (
            <details className="mb-6 w-full max-w-sm">
              <summary className="text-text-muted text-xs cursor-pointer hover:text-text-secondary text-center">
                View error details
              </summary>
          ...
          <div className="flex flex-col gap-3 w-full max-w-xs">
            ...
            <button
              ...
              className="w-full py-3 px-4 text-text-secondary hover:text-text-primary text-sm transition-colors"
            >
              Return to Home
            </button>
          </div>
