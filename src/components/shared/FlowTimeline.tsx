...
export const SALES_TIMELINE_STEPS: TimelineStep[] = [
  ...
  { step: 4, labelKey: 'sales.step.preview', fallbackLabel: 'Preview', icon: 'preview' },
  { step: 5, labelKey: 'sales.step.payment', fallbackLabel: 'Payment', icon: 'payment' },
  { step: 6, labelKey: 'sales.step.vehicle', fallbackLabel: 'Vehicle', icon: 'vehicle' },
  { step: 7, labelKey: 'sales.step.battery', fallbackLabel: 'Battery', icon: 'battery' },
  { step: 8, labelKey: 'sales.step.done', fallbackLabel: 'Done', icon: 'done' },
];
