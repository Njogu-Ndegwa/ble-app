...
const DeviceDetailView: React.FC<DeviceDetailProps> = ({
  ...
  const tabContent: Record<string, string> = {
    CMD: "Command interface will be displayed here",
    SVC: "Service information will be displayed here",
    DTA: "Data metrics will be displayed here",
    DIA: "Diagnostics will be displayed here",
  };
