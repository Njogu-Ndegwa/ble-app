...
const Swap: React.FC<SwapProps> = ({ customer }) => {
  ...
  const handleCustomerIdentification = useCallback(
    (qrCodeData: string) => {
      ...
      const responseTopic = `echo/abs/service/plan/${PLAN_ID}/identify_customer`;
      ...
      const offResponseHandler = reg(
        ...
        (data: string, responseCallback: (response: any) => void) => {
          try {
            ...
            const expectedResponseTopic = `echo/abs/service/plan/${PLAN_ID}/identify_customer`;
  ...
  const handleEquipmentIdentification = useCallback(
    (equipmentBarcode: string) => {
      ...
      const responseTopic = `echo/abs/service/plan/${PLAN_ID}/identify_equipment`;
      ...
      const offResponseHandler = reg(
        ...
        (data: string, responseCallback: (response: any) => void) => {
          try {
            ...
            const expectedResponseTopic = `echo/abs/service/plan/${PLAN_ID}/identify_equipment`;
            if (topic && topic === expectedResponseTopic) {
    ...
    const run = async () => {
      ...
      try {
        const customerResponse = await runValidationStep({
          ...
          responseTopic: `echo/abs/service/plan/${PLAN_ID}/validate_customer_status`,
      ...
      try {
        const paymentResponse = await runValidationStep({
          ...
          responseTopic: `echo/abs/service/plan/${PLAN_ID}/validate_payment_status`,
      ...
      try {
        const quotaResponse = await runValidationStep({
          ...
          responseTopic: `echo/abs/service/plan/${PLAN_ID}/validate_service_quota`,
  ...
  }, [bridge, checkoutEquipmentId, checkoutEnergyTransferred]);
  ...
  }, [currentPhase, checkoutEquipmentId, checkinEquipmentId, customerType, checkoutEnergyTransferred, mqttPublish]);
