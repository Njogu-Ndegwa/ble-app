...
//hardcode button open street map
// 'use client'
...
//     if (!isClient || !bridge || bridgeInitRef.current) return;
...
//   // Start location listener automatically when bridge is available
//   useEffect(() => {
//     if (isClient && bridge && bridgeInitRef.current) {
//       console.info("Requesting to start location listener");
//       toast.loading("Starting location listener...", { id: 'location-loading' });
...
//       );
//     }
//   }, [bridge, bridgeInitRef.current, isClient]);
