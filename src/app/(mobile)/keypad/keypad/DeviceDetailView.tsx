...
//         }}
//         placeholder="(*...#)"
//         className="font-mono h-8 mt-1 truncate p-1 bg-gray-900 rounded w-full text-white"
//         style={{
//           fontSize:
//             inputCode.length > 20 ? '0.75rem' : inputCode.length > 15 ? '0.875rem' : '1rem',
//         }}
...
//   const handleManualPaste = (event: React.ChangeEvent<HTMLInputElement>) => {
//     const text = event.target.value;
//     const cleanedText = text.trim().replace(/[^0-9*#]/g, '');
//     if (cleanedText.length > 23) {
//       toast.error('Pasted code exceeds 23 characters');
//       return;
//     }
//     if (cleanedText.length < 23) {
//       toast.error('Pasted code is less than 23 characters');
//       return;
//     }
...
//       return;
//     }
//     setInputCode(formatInputCode(cleanedText));
...
//     writeCharacteristic(pubkCharacteristic, raw, () => {
//       setTimeout(() =>
//         handleRead(cmdService!.uuid, pubkCharacteristic.uuid, pubkCharacteristic.name),
//       1000);
//     });
...
//         <p className="text-sm text-gray-400">Input Code:</p>
//         <button
//           className="bg-gray-700 hover:bg-gray-600 text-white text-sm font-semibold rounded-lg px-3 py-1"
...
//             className="w-full p-2 bg-gray-900 text-white rounded-lg font-mono text-sm"
