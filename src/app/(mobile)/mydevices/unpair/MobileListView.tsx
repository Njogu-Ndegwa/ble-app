...
const MobileListView: React.FC<MobileListViewProps> = ({
  ...
  const handleSubmitQrCode = (e: React.MouseEvent | React.KeyboardEvent) => {
    e.preventDefault();
    if (qrCodeInput.trim()) {
      console.log('Raw QR code input:', qrCodeInput.trim());
      onSubmitQrCode(qrCodeInput.trim()); // Pass full code as entered
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="text-center flex-1">
            <h2 className="text-white font-medium">Unpair Device</h2>
          </div>
        ...
        <div className="space-y-3">
          {items.length === 0 && isScanning ? (
            ...
            <div className="text-center py-6 text-gray-400">
              Scan or enter a QR code to unpair a device.
            </div>
          ) : (
            <div className="text-center py-6 text-gray-400">
