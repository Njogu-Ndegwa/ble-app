...
import BleDevicesNav, { type BleDevicesScreen } from './components/BleDevicesNav';
...
const BleDevicesApp: React.FC = () => {
  ...
  const handleNavigate = useCallback((screen: BleDevicesScreen) => {
  ...
  return (
    <div className="attendant-container has-bottom-nav">
        ...
        <div className="flow-header-inner">
          <div className="flow-header-left">
            <button
              ...
              aria-label={t('ble.profile.changeRole') || 'Change Role'}
              title={t('ble.profile.changeRole') || 'Change Role'}
            >
      ...
      <BleDevicesNav currentScreen={currentScreen} onNavigate={handleNavigate} />
    </div>
  );
};
