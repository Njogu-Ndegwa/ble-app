      ...
      {customerMode === 'new' && (
        <>
          <FormSection title={t('sales.personalInfo')}>
            ...
            {/* Contact info hint */}
            <div className="flex items-center gap-2 p-3 bg-info-soft border border-info-border rounded-lg mb-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-info flex-shrink-0">
