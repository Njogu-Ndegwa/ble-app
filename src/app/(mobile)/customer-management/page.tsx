...
const CustomerApp = dynamic(() => import('./CustomerApp'), {
...
export default function CustomerManagementPage() {
  ...
  const loadServiceAccounts = useCallback(async (token: string) => {
    ...
    try {
      ...
      console.error('[CustomerManagement] Failed to load SAs:', err);
  ...
  return (
    <>
      ...
      {screen === 'app' && <CustomerApp onLogout={handleLogout} onSwitchSA={handleSwitchSA} />}
    </>
  );
}
